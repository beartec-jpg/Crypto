      ...
      {location === '/' ? (
        <div style={{ textAlign: 'center', padding: '50px', fontFamily: 'Arial', background: '#f0f0f0', minHeight: '100vh' }}>
          ...
          <div className="landing">
            ...
            <img src="https://via.placeholder.com/400x200/667eea/ffffff?text=Crypto+Chart+Preview" alt="Crypto Image" style={{ borderRadius: '10px', margin: '20px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', width: '400px' }} />
        ...
        <div style={{ padding: '20px' }}>Dashboard (Elliott Wave Analysis)</div>
      )}
    </Router>
  )
}
